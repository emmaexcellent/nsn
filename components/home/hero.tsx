...
import { ArrowRight, Users, Award, Globe, DollarSign, ChevronRight } from "lucide-react"
          ...
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/scholarships">
                <Button size="lg" className="bg-gold hover:bg-gold/90 text-navy font-semibold text-lg px-8 py-4 group">
