...
const blogPosts = [
  {
    ...
    excerpt:
      "Learn the essential strategies that make scholarship essays stand out from the competition.",
  ...
  },
  {
    ...
    excerpt:
      "Read how one student overcame challenges and secured a full scholarship to Harvard University.",
