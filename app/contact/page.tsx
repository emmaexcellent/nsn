              ...
              <div className="flex items-center justify-center">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-sm text-gray-400">
                    123 Education Boulevard, Learning City
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Use our advanced search filters on the scholarships page to
                    find opportunities that match your profile, field of study,
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Our team updates the database daily with new opportunities
                    and removes expired scholarships to ensure you have access
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Organizations can submit scholarships through our
                    partnership program. Contact us using the form above for
                    more information about adding opportunities.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white mb-2">
